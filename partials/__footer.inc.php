      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Design and development of the website <a href="http://jankovicmilan.in.rs/" target="_blank" >Milan Janković</a> © <script>document.write(new Date().getFullYear());</script> © All rights reserved
            </p>
            </div>
          </div>
